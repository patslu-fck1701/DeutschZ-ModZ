...
const string DZBBC_LOCATIONS_JSON = "$profile:DZBBC/dzbbc_locations.json";
const string DZBBC_AI_WAVES_JSON = "$profile:DZBBC/dzbbc_ai_waves.json";
const string DZBBC_LOOT_JSON = "$profile:DZBBC/dzbbc_loot.json";
const string DZBBC_TERMINALS_JSON = "$profile:DZBBC/dzbbc_terminals.json";
const string DZBBC_MESSAGES_JSON = "$profile:DZBBC/dzbbc_messages.json";

const string DZBBC_MOD_ROOT = "deutschz_blackbox_convoyz";
const string DZBBC_DEFAULT_MARKER_ICON = "\\deutschz_blackbox_convoyz\\data\\textures\\convoyz\\cardreader_gpsreceiver_co.paa";
