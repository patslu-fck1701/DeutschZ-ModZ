modded class LoadingScreen
{
	...
	void LoadingScreen(DayZGame game)
	{
		...
		m_DZKOTHG_LoadingOverlay = game.GetLoadingWorkspace().CreateWidgets("DeutschZ_MenuMusic_V2_Test/gui/dzkothg_loading_overlay.layout", m_WidgetRoot);
	...
	protected void DZKOTHG_ApplyLoadingScreen(bool resetTimer)
	{
		...
		{
			m_ImageWidgetBackground.LoadMaskTexture("DeutschZ_MenuMusic_V2_Test/data/ui/loading/null.paa");
